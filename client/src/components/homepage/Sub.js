...
const Sub = () => {
    ...
    color="darkgoldenrod"
  />
  <div>Very good experience. Got the settlement done in less than 24 hours.</div>
  <div className='sub_rate'>
  <div>
<img src={e1} style={{marginRight:"20px", marginTop:"6px"}}></img>
  </div>
  <div>
...
Thank you so much for the amazing service, Special thanks to Mr. Rais Shaikh.</div>
  <div className='sub_rate'>
  <div>
<img src={e2} style={{marginRight:"20px",marginTop:"6px"}}></img>
  </div>
  <div>
...
Hassle free insurance & quick response. Absolutely best insurance company ever</div>
  <div className='sub_rate'>
  <div>
<img src={e3} style={{marginRight:"20px", marginTop:"6px"}}></img>
  </div>
  <div>
